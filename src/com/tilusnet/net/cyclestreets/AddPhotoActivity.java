...
import com.tilusnet.net.cyclestreets.api.PhotomapCategories;
import com.tilusnet.net.cyclestreets.api.PhotomapCategory;
import com.tilusnet.net.cyclestreets.api.Upload;
import com.tilusnet.net.cyclestreets.util.Bitmaps;
import com.tilusnet.net.cyclestreets.util.Dialog;
import com.tilusnet.net.cyclestreets.util.MessageBox;
import com.tilusnet.net.cyclestreets.util.Share;
import com.tilusnet.net.cyclestreets.views.CycleMapView;
import com.tilusnet.net.cyclestreets.views.overlay.ThereOverlay;
import com.tilusnet.net.cyclestreets.views.overlay.ThereOverlay.LocationListener;
